...
private:
    ...
    enum class ResultType { LIST, HIERARCHY, PATH, CYCLE };
    ...
    CmdResult cmd_roads(std::ostream& output, MatchIter begin, MatchIter end);
    ...
    void print_town(TownID id, std::ostream& output);
    ...
    void add_random_roads(unsigned int random_roads);
